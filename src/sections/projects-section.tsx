  ...
  return (
    <div className="bg-background py-20">
      <div id="projects" className="mx-auto w-11/12 max-w-6xl">
        <h2 className="bg-background top-[3.05rem] left-0 z-20 mb-6 pt-4 pb-3 text-2xl after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:bg-linear-to-r after:from-zinc-400 after:to-zinc-200 sm:sticky">
          {t('projects.title')}
        </h2>

...
import type { Technology } from '@/data/tecnologies'
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['cobra'],
    languages: ['go'],
    githubUrl: 'https://github.com/orochaa/go-clack?tab=readme-ov-file#readme',
  ...
  },
  {
    ...
    technologies: [],
    languages: ['go'],
    githubUrl: 'https://github.com/orochaa/go-mailer?tab=readme-ov-file#readme',
